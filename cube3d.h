...
# define rotSpeed 3.141592653589793238462643383279502884/32
...
** draw.c
*/
void		draw_inside(t_spec *inf, int draw_start, int draw_end, int tex_num);
...
t_spec      *init_spec(char *pathToCub);
/*
** math.c
*/
